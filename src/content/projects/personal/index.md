...
sustainable, largely universal tool covers â€” and from there moved into
...
Research told me I needed a visible element of uniqueness â€” something that read
as handmade â€” so I moved away from the traditional bifold. I designed around four
...
gap showed up immediately in the first wave of orders â€” I couldn't keep up, so I
...
**Where it landed:** I hit what I set out to do â€” real experience in product
...
**Problem statement:** Build a macropad capable of passing two typing tests â€” one
predetermined string, one surprise string â€” and win a competition for the most
attractive design.
...
features. For the competition, I underestimated how much people valued novelty â€”
...
already had â€” a battery from a dead power bank, drivers from a water-damaged
...
Wi-Fi pushed me to a Pi 4. This was the hardest phase and my favorite â€” it's
...
Technically, the components need a real mounting strategy â€” the buttons and knobs
...
These projects â€” the cutting board especially â€” were built to become
...
parametric â€” every dimension is relative â€” so I can re-target the same model to
...
inserts to absorb impact â€” PLA deliberately, so that in the worst case the case
...
version â€” without an enclosed printer the TPU prints failed consistently. I'm
...
so the same package can drop into future projects â€” a light bar for the top of my
...
two buck converters â€” two because the LED strip wants 12 V and the microcontroller
...
assembly and disassembly for moving, built from materials I already had â€” and
...
my goals â€” and that 3D printing them would make it cheap. For the look, I wanted
...
Kingroon â€” $4.05. Checking my old order, 25 dowels cost $21, so $0.84 each; the
...
connectors so the rack can be screwed down if I ever land somewhere permanent â€”
